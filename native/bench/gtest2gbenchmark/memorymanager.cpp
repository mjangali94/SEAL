...
{
    void MemoryPoolHandleTest_MemoryPoolHandleConstructAssign(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void MemoryPoolHandleTest_MemoryPoolHandleAllocate(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void MemoryPoolHandleTest_UseCount(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
