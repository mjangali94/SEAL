...
{
    void EncryptorTest_BFVEncryptDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EncryptorTest_BFVEncryptZeroDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EncryptorTest_CKKSEncryptZeroDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EncryptorTest_CKKSEncryptDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EncryptorTest_BGVEncryptDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EncryptorTest_BGVEncryptZeroDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
