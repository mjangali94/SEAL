...
{
    void CiphertextTest_BFVCiphertextBasics(State &state)
    {
    ...
    void CiphertextTest_BFVSaveLoadCiphertext(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void CiphertextTest_BGVCiphertextBasics(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void CiphertextTest_BGVSaveLoadCiphertext(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
