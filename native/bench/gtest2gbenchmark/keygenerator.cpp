...
{
    void KeyGeneratorTest_BFVKeyGeneration(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void KeyGeneratorTest_BGVKeyGeneration(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void KeyGeneratorTest_CKKSKeyGeneration(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void KeyGeneratorTest_Constructors(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
