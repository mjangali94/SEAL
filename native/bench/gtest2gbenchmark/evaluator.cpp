...
{
    void EvaluatorTest_BFVEncryptNegateDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptAddDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptNegateDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptAddDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptAddDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptAddPlainDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptSubPlainDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptSubDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptAddPlainDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptSubPlainDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptMultiplyPlainDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptMultiplyDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptSubDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptAddPlainDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptSubPlainDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptMultiplyPlainDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptMultiplyDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
...
#include "seal/randomgen.h"
    void EvaluatorTest_BFVRelinearize(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVRelinearize(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptNaiveMultiplyDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptMultiplyByNumberDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptMultiplyRelinDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptSquareRelinDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptMultiplyRelinRescaleDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptSquareRelinRescaleDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptModSwitchDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptMultiplyRelinRescaleModSwitchAddDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptRotateDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_CKKSEncryptRescaleRotateDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptSquareDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptMultiplyManyDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptExponentiateDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptAddManyDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptSquareDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptMultiplyManyDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptExponentiateDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptAddManyDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_TransformPlainToNTT(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_TransformEncryptedToFromNTT(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptMultiplyPlainNTTDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptApplyGaloisDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptRotateMatrixDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptModSwitchToNextDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BFVEncryptModSwitchToDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptMultiplyPlainNTTDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptApplyGaloisDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptRotateMatrixDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptModSwitchToNextDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EvaluatorTest_BGVEncryptModSwitchToDecrypt(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
