...
namespace gtest2gbenchmark
{
    namespace util
    {
        void IteratorTest_IterType(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void IteratorTest_Iterate(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void IteratorTest_SeqIter(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void IteratorTest_PtrIter(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void IteratorTest_StrideIter(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void IteratorTest_RNSIter(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void IteratorTest_PolyIter(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void IteratorTest_IterTuple(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void IteratorTest_ReverseIter(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
