...
namespace gtest2gbenchmark
{
    namespace util
    {
        void NumberTheory_GCD(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void NumberTheory_ExtendedGCD(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void NumberTheory_TryInvertUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void NumberTheory_IsPrime(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void NumberTheory_NAF(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void NumberTheory_TryPrimitiveRootMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void NumberTheory_IsPrimitiveRootMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void NumberTheory_TryMinimalPrimitiveRootMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
