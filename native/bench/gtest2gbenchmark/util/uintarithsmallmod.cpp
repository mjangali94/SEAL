...
namespace gtest2gbenchmark
{
    namespace util
    {
        void UIntArithSmallMod_IncrementUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_DecrementUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_NegateUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_Div2UIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_AddUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_SubUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_BarrettReduce128(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_MultiplyUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_MultiplyAddMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_ModuloUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_TryInvertUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_ExponentiateUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_DotProductMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_MultiplyUIntModOperand(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_MultiplyUIntMod2(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_MultiplyUIntModLazy(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithSmallMod_MultiplyAddMod2(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
