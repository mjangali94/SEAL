...
namespace gtest2gbenchmark
{
    namespace util
    {
        void NTTTablesTest_NTTBasics(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void NTTTablesTest_NTTPrimitiveRootsTest(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void NTTTablesTest_NegacyclicNTTTest(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void NTTTablesTest_InverseNegacyclicNTTTest(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
