...
namespace gtest2gbenchmark
{
    namespace util
    {
        void UIntCore_AllocateUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_SetZeroUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_AllocateZeroUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_SetUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_SetUInt2(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_SetUInt3(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_IsZeroUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_IsEqualUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_IsBitSetUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_IsHighBitSetUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_SetBitUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_GetSignificantBitCountUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_GetSignificantUInt64CountUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_GetNonzeroUInt64CountUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_FilterHighBitsUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_CompareUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_GetPowerOfTwo(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntCore_DuplicateUIntIfNeeded(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
