...
namespace gtest2gbenchmark
{
    namespace util
    {
        void Common_Constants(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void Common_UnsignedComparisons(State &state)
        { 
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void Common_SafeArithmetic(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void Common_FitsIn(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void Common_DivideRoundUp(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void Common_HammingWeight(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void Common_ReverseBits32(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void Common_ReverseBits64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void Common_GetSignificantBitCount(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void Common_GetMSBIndexGeneric(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
