...
namespace gtest2gbenchmark
{
    namespace util
    {
        void PolyCore_AllocatePoly(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyCore_SetZeroPoly(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyCore_AllocateZeroPoly(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyCore_AllocatePolyArray(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyCore_SetZeroPolyArray(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyCore_AllocateZeroPolyArray(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyCore_SetPoly(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyCore_SetPolyArray(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
