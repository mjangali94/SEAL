...
namespace gtest2gbenchmark
{
    namespace util
    {
        void UIntArith_AddUInt64Generic(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
...
#pragma clang optimize off
        ...
        void UIntArith_AddUInt64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
...
#pragma clang optimize on
        ...
        void UIntArith_SubUInt64Generic(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_SubUInt64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_AddUInt128(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_AddUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_SubUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_AddUIntUInt64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_SubUIntUInt64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_IncrementUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_DecrementUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_NegateUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_LeftShiftUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_LeftShiftUInt128(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_LeftShiftUInt192(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_RightShiftUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_RightShiftUInt128(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_RightShiftUInt192(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_HalfRoundUpUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_NotUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_AndUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_OrUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_XorUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_MultiplyUInt64Generic(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_MultiplyUInt64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_MultiplyUInt64HW64Generic(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_MultiplyUInt64HW64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_MultiplyManyUInt64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_MultiplyManyUInt64Except(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_MultiplyUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_MultiplyUIntUInt64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_DivideUInt(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_DivideUInt128UInt64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_DivideUInt192UInt64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArith_ExponentiateUInt64(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
