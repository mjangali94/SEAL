...
namespace gtest2gbenchmark
{
    namespace util
    {
        void MemoryPoolTest_TestMemoryPoolMT(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void MemoryPoolTests_PointerTestsMT(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void MemoryPoolTests_TestMemoryPoolST(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void MemoryPoolTests_PointerTestsST(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void MemoryPoolTests_Allocate(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
