...
namespace gtest2gbenchmark
{
    namespace util
    {
        void UInt64ToString_NibbleToUpperHexTest(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UInt64ToString_UInt64ToHexString(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UInt64ToString_UInt64ToDecString(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UInt64ToString_PolyToHexString(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
