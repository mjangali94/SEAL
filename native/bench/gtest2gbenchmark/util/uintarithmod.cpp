...
namespace gtest2gbenchmark
{
    namespace util
    {
        void UIntArithMod_IncrementUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithMod_DecrementUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithMod_NegateUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithMod_Div2UIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithMod_AddUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithMod_SubUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void UIntArithMod_TryInvertUIntMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
