...
namespace gtest2gbenchmark
{
    namespace util
    {
        void PolyArithSmallMod_ModuloPolyCoeffs(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyArithSmallMod_NegatePolyCoeffMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyArithSmallMod_AddPolyCoeffMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyArithSmallMod_SubPolyCoeffMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyArithSmallMod_MultiplyPolyScalarCoeffMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyArithSmallMod_MultiplyPolyMonoCoeffMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyArithSmallMod_DyadicProductCoeffMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyArithSmallMod_PolyInftyNormCoeffMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
        ...
        void PolyArithSmallMod_NegacyclicShiftPolyCoeffMod(State &state)
        {
            for (auto _ : state)
            {
                state.PauseTiming();
