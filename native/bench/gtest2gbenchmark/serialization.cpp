...
namespace gtest2gbenchmark
{
    ...
    void SerializationTest_IsValidHeader(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void SerializationTest_SEALHeaderSaveLoad(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    */
    void SerializationTest_SaveLoadToStream(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void SerializationTest_SaveLoadToBuffer(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
