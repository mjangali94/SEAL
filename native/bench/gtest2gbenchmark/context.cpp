...
{
    void ContextTest_BFVContextConstructor(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void ContextTest_ModulusChainExpansion(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EncryptionParameterQualifiersTest_BFVParameterError(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void ContextTest_BGVContextConstructor(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EncryptionParameterQualifiersTest_BGVParameterError(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
