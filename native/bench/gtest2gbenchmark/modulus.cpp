...
{
    void ModulusTest_CreateModulus(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void ModulusTest_CompareModulus(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void ModulusTest_SaveLoadModulus(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void ModulusTest_Reduce(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void CoeffModTest_CustomExceptionTest(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void CoeffModTest_CustomTest(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
