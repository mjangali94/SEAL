...
namespace gtest2gbenchmark
{
    ...
    void RandomGenerator_UniformRandomCreateDefault(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void RandomGenerator_RandomGeneratorFactorySeed(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void RandomGenerator_SequentialRandomGenerator(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void RandomGenerator_RandomUInt64(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void RandomGenerator_SeededRNG(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void RandomGenerator_RandomSeededRNG(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void RandomGenerator_MultiThreaded(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void RandomGenerator_UniformRandomGeneratorInfo(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void RandomGenerator_UniformRandomGeneratorInfoSaveLoad(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
