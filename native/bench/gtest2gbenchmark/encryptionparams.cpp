...
{
    void EncryptionParametersTest_EncryptionParametersSet(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
            ...
            auto encryption_parameters_test = [](scheme_type scheme) {
                ...
                ASSERT_TRUE(is_prime(parms.coeff_modulus()[0]));
                ASSERT_TRUE(is_prime(parms.coeff_modulus()[1]));
                ASSERT_TRUE(is_prime(parms.coeff_modulus()[2]));
    ...
    void EncryptionParametersTest_EncryptionParametersCompare(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
    ...
    void EncryptionParametersTest_EncryptionParametersSaveLoad(State &state)
    {
        for (auto _ : state)
        {
            state.PauseTiming();
